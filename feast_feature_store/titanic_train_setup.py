...
titanic_file_source = FileSource(
    path="/Users/sfeda/Projects/PEEX/feature_store_pet/feast_feature_store/data/titanic_train_file_source.parquet",
...
driver_stats_fs = FeatureService(
    name="passenger_activity", features=[passenger_stats]
)
